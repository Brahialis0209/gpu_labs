...
XMFLOAT3 constexpr EYE{ 0.0f, 0.0f, -12.0f };
...
struct ConstBuf {
	XMMATRIX world; // 16
	XMMATRIX view; // 16
	XMMATRIX projection;// 16
	XMFLOAT4 vLightDir[NUM_OF_LIGHT]; //12
...
public:
	...
	void Process(ComPtr<ID3D11DeviceContext> ctx, ComPtr<ID3D11ShaderResourceView> sourceTexture, 
